...
public class NlqcTestContainer extends TestContainer {

    public NlqcTestContainer() {
        super();
    ...
    public static class Common extends NlqcTestContainer {

        public static final NlqcTestContainer.Common INSTANCE = new NlqcTestContainer.Common();
